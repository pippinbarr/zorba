package
{
	...
	public class ZorbaPreloader extends FlxPreloader {
		...
		[Embed(source="assets/background/ZorbaBeach.png")]
		private var ZORBA_BEACH:Class;
		...
		public function ZorbaPreloader() {			
			className = "Zorba";
			super();
		}
